...
exports.getOrCreateAboutPage = getOrCreateAboutPage;
const mongoose_1 = __importStar(require("mongoose"));
const visionPointSchema = new mongoose_1.Schema({
...
async function getOrCreateAboutPage() {
    return (await exports.AboutPage.findOne()) || (await exports.AboutPage.create({}));
}
